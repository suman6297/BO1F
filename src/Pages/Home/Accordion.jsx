...
const Accordion = ({ title, answer }) => {
  ...
  return (
    <div className="  border-gray-400 shadow-gray-400 shadow-md ">
      <button
        onClick={() => setAccordionOpen(!accordionOpen)}
        className=" w-full pt-8 flex justify-between items-center font-cormorant  text-gray-500 text-xl hover:text-callto-action"
      >
        <span className="text-left font-bold text-black px-5">{title}</span>
        {/* {accordionOpen ? <span>-</span> : <span>+</span>} */}
        <svg
          className="fill-black shrink-0 mr-8"
          width="16"
          height="16"
